...
namespace TextWork.Plugins.TextReplacer
{
    public class TextReplacerPlugin : IAnalyzePlugin
    {
        ...
        public TextReplacerPlugin(string targetWord, string replacementWord)
        {
